...
def call_openai_chat(
    ...
    # Gemini-compatible endpoint; final reaction condition answer is expected in message.content.
    payload = {
        "model": model,
...
def main() -> None:
    ...
    parser.add_argument("--model", default=os.getenv("OPENAI_MODEL", "Gemini3.5flash"))
    parser.add_argument(
        "--base-url",
